...
#About Project
    ...
    st.markdown("""
                ### About Project
                My deep interest in music and my hobby of listening to different genres inspired me to take up the Music Genre Classification Using Neural Networks project. I wanted to explore how machine learning can analyze sound patterns, such as spectrograms, to accurately identify genres.

                For this project, I focused on improving genre classification performance using Convolutional Neural Networks (CNNs). I utilized libraries like Librosa, Keras, and TensorFlow to extract features and build the model. I also drew insights from a research paper on music genre classification, which helped me enhance my code for better accuracy and performance.
